      ...
      >
        <Box sx={{ mx: 'auto', maxWidth: 400 }}>
          ...
          <form noValidate autoComplete='off' onSubmit={onSubmit}>
            ...
            {/*Name*/}
            <TextField inputRef={nameRef} autoFocus fullWidth sx={{ mb: 4 }} label='Username' placeholder='johndoe' />

            {/*Email*/}
            <TextField inputRef={emailRef} fullWidth label='Email' sx={{ mb: 4 }} placeholder='user@email.com' />
